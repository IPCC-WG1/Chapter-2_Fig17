##########################################################################
# ---------------------------------------------------------------------------------------------------------------------
# This is MATLAB code to produce IPCC AR6 WGI Figure 2.17, panel b
# Creator: Juan A. Rivera, IANIGLA/CONICET 
# Contact: jrivera@mendoza-conicet.gob.ar
# Last updated on: July 8th, 2021
# --------------------------------------------------------------------------------------------------------------------
#
# - Code functionality: HCintensity_NH.m: This code plots the time series of annual mean Northern Hemisphere Hadley Cell intensity for the period 1980-2019 for a variety of datasets
			HCintensity_SH.m: This code plots the time series of annual mean Southern Hemisphere Hadley Cell intensity for the period 1980-2019 for a variety of datasets
# - Input data: MATLAB file of annual mean Northern and Southern Hemisphere Hadley Cell intensity from a variety of datasets. The file can be accessed at: *Link to CEDA catalogue*
# - Output variables: The code plots the panels of figure 2.17 panel b as in the report
#
# ----------------------------------------------------------------------------------------------------
...
#
# ----------------------------------------------------------------------------------------------------
# How to cite: https://doi.org/10.5281/zenodo.6340021
